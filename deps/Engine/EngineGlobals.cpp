...
void EngineGlobals::init()
{
	...
	EngineGlobals::Theme::text        = 0;
	EngineGlobals::Theme::hilite_text = Colors::pair(COLOR_CYAN, COLOR_DEFAULT);
	EngineGlobals::Theme::textbox     = (EngineGlobals::Theme::hilite_text | A_REVERSE);
}
